...
[g8in, g8out] =     genera_diag_geom(37.5, 113.4, 164, 14, FI_10, FI_8, 'Geometría 8');   % M7X
...
[g13in, g13out] =   genera_diag_geom(37.5, 260,   232,    14, FI_12, FI_8, 'Geometría 13');  % M12X
cargar_piers({'M12X'}, g13in, g13out, dataresd, ndt, 'g13');

[g14in, g14out] =   genera_diag_geom(37.5, 208,  97,   14, FI_12, FI_8, 'Geometría 14');  % M13X
cargar_piers({'M17X'}, g14in, g14out, dataresd, ndt, 'g14');

[g15in, g15out] =   genera_diag_geom(37.5, 94.6, 322,   14, FI_10, FI_8, 'Geometría 15');  % M14X
